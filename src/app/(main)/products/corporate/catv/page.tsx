        ...
        <div className="relative mt-12">
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-[720px] text-sm leading-6 text-slate-500 md:text-base">
              Байгууллагын хэрэглээнд тохирсон, дуу дүрсний өндөр чанартай,
              найдвартай кабелийн телевизийн үйлчилгээ.
            </p>
          </div>
          ...
          <div className="relative z-10 mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-[720px] text-sm leading-6 text-slate-500 md:text-base">
                STANDARD болон PREMIUM багцаас байгууллагынхаа хэрэгцээнд
          ...
          <div className="relative z-10 mb-8 grid grid-cols-1 gap-4 md:grid-cols-4">
            <div className="rounded-2xl border border-blue-100 bg-blue-50/70 p-4">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-600">
                Оффис, үйлчилгээний газар болон байгууллагын хэрэглээнд
                тохиромжтой.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-blue-100 bg-blue-50/70 p-4">
              ...
              <h3 className="font-black text-[#061f57]">Олон суваг</h3>

              <p className="mt-1 text-sm leading-6 text-slate-600">
                Монгол, хүүхэд, спорт, кино, танин мэдэхүй, мэдээллийн сувгууд.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-blue-100 bg-blue-50/70 p-4">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-600">
                PREMIUM багцад спортын сувгийн өргөн сонголттой.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-blue-100 bg-blue-50/70 p-4">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-600">
                Кино болон энтертайнмент сувгийн сонголттой.
              </p>
            </div>
          </div>
          ...
          <div className="relative z-10 mx-auto grid max-w-[860px] grid-cols-1 gap-6 md:grid-cols-2">
            <Price
              ...
              list={[
                ...
                "Монгол суваг 42 суваг",
                "Спорт суваг 0",
                "Хүүхдийн суваг 1",
                "Танин мэдэхүйн суваг 0",
                "Кино, интертэймент суваг 11",
