        ...
        <div className="relative mt-12">
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-[700px] text-sm leading-6 text-slate-500 md:text-base">
              Интернэтээр дамжуулан хүссэн төхөөрөмжөөсөө ТВ суваг, кино,
              контентыг өндөр чанартайгаар үзэх боломж.
            </p>
          </div>
          ...
          <div className="relative z-10 mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-[720px] text-sm leading-6 text-slate-500 md:text-base">
                STANDARD болон PREMIUM багцаас өөрийн үзэх хэрэгцээнд тохируулан
                сонгоорой.
              </p>
            </div>
          ...
          <div className="relative z-10 mb-8 grid grid-cols-1 gap-4 md:grid-cols-4">
            <div className="rounded-2xl border border-blue-100 bg-blue-50/70 p-4">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-600">
                PREMIUM багцад олон төрлийн ТВ сувгууд дагалдана.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-blue-100 bg-blue-50/70 p-4">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-600">
                Хуваарьт нэвтрүүлгийг 96 цаг хүртэл нөхөж үзэх боломжтой.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-blue-100 bg-blue-50/70 p-4">
              ...
              <h3 className="font-black text-[#061f57]">Ухаалаг төхөөрөмж</h3>

              <p className="mt-1 text-sm leading-6 text-slate-600">
                Гар утас, таблет, smart TV зэрэг төхөөрөмжөөр үзэх боломжтой.
              </p>
            </div>
          </div>
